...
local _1_
do
  local name_4_auto = "dotfiles.module.neoformat"
  local module_5_auto
  do
...
local function _6_(...)
  ...
  local function _5_()
    return {require("dotfiles.util.neoformat")}
  end
  ok_3f_21_auto, val_22_auto = pcall(_5_)
  if ok_3f_21_auto then
    _1_["aniseed/local-fns"] = {require = {neoformat = "dotfiles.util.neoformat"}}
    return val_22_auto
  else
